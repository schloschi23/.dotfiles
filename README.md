...
## packagages
those are the packages i am running on my system
...
* **[tldr](https://wiki.archlinux.org/title/Man_page#tldr)** - short version
  of man pages for everyday usage
...
* **[zathura](https://wiki.archlinux.org/title/Zathura)** - vim-like pdf
  viewer
* **[zathura-pdf-poppler](https://wiki.archlinux.org/title/Zathura)** -
  zathura pdf support plugin 

### System
* **[networkmanager](https://wiki.archlinux.org/title/NetworkManager)** - i
  fail to connect to the wifi 7 / 10 times with this one.
...
* **[rsync](https://wiki.archlinux.org/title/Rsync)** - fast and versatile
  file copying tool that synchronizes files locally or remotely.
...
* **[swaybg](https://wiki.archlinux.org/title/Sway#Wallpaper)** - wallpaper
  utility for Sway (make sure to check out my wallpapers)
* **[swayidle](https://wiki.archlinux.org/title/Sway#Idle_configuration)** -
  idle management daemon for Wayland
* **[swaylock](https://wiki.archlinux.org/title/Sway#Screen_locking)** -
...
### Working
* **[neovim](https://wiki.archlinux.org/title/Neovim)** - highly configurable
  text editor for people with adhd
* **[openssh](https://wiki.archlinux.org/title/OpenSSH)** - tool for remote
  login on my home server with the SSH protocol.
...
* **[wireguard-tools](https://wiki.archlinux.org/title/WireGuard)** - tools
  for configuring secure network tunnels.

### Languages
* **[r](https://wiki.archlinux.org/title/R)** - language and environment for
  statistical computing
* **[ruby](https://wiki.archlinux.org/title/Ruby)** - open source dynamic
...
* **[wf-recorder](https://wiki.archlinux.org/title/Screen_capture#Wayland)** -
  screen recorder
...
### Security
* **[pass](https://wiki.archlinux.org/title/Pass)** - minimalist password
  manager that stores in GPG-encrypted files.
* **[yubikey-full-disk-encryption](https://wiki.archlinux.org/title/YubiKey#Linux_user_authentication_with_PAM)**
  - Tools to use a YubiKey for unlocking LUKS encrypted disks
* **[yubikey-manager](https://wiki.archlinux.org/title/YubiKey#Configuration_tools)**
  - command-line tool to configure YubiKey
